<script lang="ts">
  ...
  const hint = $derived(layout === "axes" ? "positioned by where each card projects on the two axes" : layout === "orbit" ? "drag to orbit · scroll to dive in and out" : "proximity = similarity · tap a card");
